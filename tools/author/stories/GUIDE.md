...
| `space` | `confetti` (a birthday, a party, a hooray, a happy ending), `bubbles` (bath time, blowing bubbles, a party; under the sea, something bubbling up), `shootingstars` (making a wish, wonder, look!), `nebula` (a magical place, wonder, a dreamy moment) | the sentence where something appears or changes in the sky |
