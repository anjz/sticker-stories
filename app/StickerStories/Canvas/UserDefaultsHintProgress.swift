...
/// (pinch, layer button) so their hints stop. Compliance note: app-internal
/// state only, never sent anywhere — covered by the CA92.1 declaration in
/// PrivacyInfo.xcprivacy, like `UserDefaultsRecentStories`.
