...
| `underwater` | `bubbles` (bath time, blowing bubbles, a party; under the sea, something bubbling up), `sunrays` (a bright day under the sea, swimming up towards the light), `ripples` (shallow water, a sunny lagoon, calm and playful), `deepwater` (diving deeper, exploring, bedtime under the sea; never darkness as a threat), `glowplankton` (a little magic in the dark sea; over deepwater) | the sentence where the water or the light changes |
